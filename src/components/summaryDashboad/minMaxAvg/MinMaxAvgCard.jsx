            ...
            <li className="list-group-item">
              <div className="row">
                ...
                <div className="col col-md-7 text-center">
                  ...
                  <div className="device-date text-muted">{minDevice.date.substring(0,10)}</div>
                  <div className="device-date text-muted">{minDevice.date.substring(11,19)}</div>
                </div>
            ...
            <li className="list-group-item">
              <div className="row">
                ...
                <div className="col col-md-7 text-center">
                  ...
                  <div className="device-date text-muted">{maxDevice.date.substring(0,10)}</div>
                  <div className="device-date text-muted">{maxDevice.date.substring(11,19)}</div>
                </div>
                <div className="col col-md-4 text-center">
